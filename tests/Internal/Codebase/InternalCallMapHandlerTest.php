...
class InternalCallMapHandlerTest extends TestCase
{
    ...
    private static array $ignoredFunctions = [
        'argumentcounterror::__clone' => ['8.3'],
        'arithmeticerror::__clone' => ['8.3'],
        'array_multisort',
        'badfunctioncallexception::__clone' => ['8.3'],
        'badmethodcallexception::__clone' => ['8.3'],
        'closedgeneratorexception::__clone' => ['8.3'],
        'datefmt_create' => ['8.0'],
        'domainexception::__clone' => ['8.3'],
        'errorexception::__clone' => ['8.3'],
        'fiber::start',
        'imagefilledpolygon',
        'imagegd',
        'imagegd2',
        'imageopenpolygon',
        'imagepolygon',
        'intlcodepointbreakiterator::__construct' => ['8.3'],
        'intlexception::__clone' => ['8.3'],
        'intlgregoriancalendar::__construct',
        'invalidargumentexception::__clone' => ['8.3'],
        'jsonexception::__clone' => ['8.3'],
        'lengthexception::__clone' => ['8.3'],
        'logicexception::__clone' => ['8.3'],
        'lzf_compress',
        'lzf_decompress',
        ...
        'ocigetbufferinglob',
        'ocisetbufferinglob',
        'outofboundsexception::__clone' => ['8.3'],
        'outofrangeexception::__clone' => ['8.3'],
        'overflowexception::__clone' => ['8.3'],
        'parseerror::__clone' => ['8.3'],
        'rangeexception::__clone' => ['8.3'],
        'recursiveiteratoriterator::__construct', // Class used in CallMap does not exist: recursiveiterator
        'reflectionnamedtype::__clone' => ['8.3'],
        'reflectionobject::__clone' => ['8.3'],
        'runtimeexception::__clone' => ['8.3'],
        'sqlsrv_fetch_array',
        'sqlsrv_fetch_object',
        'sqlsrv_get_field',
        'sqlsrv_prepare',
        ...
        'sqlsrv_server_info',
        'ssh2_forward_accept',
        'typeerror::__clone' => ['8.3'],
        'underflowexception::__clone' => ['8.3'],
        'unexpectedvalueexception::__clone' => ['8.3'],
        'xdiff_file_bdiff',
    ...
    private static array $ignoredReturnTypeOnlyFunctions = [
        ...
        'intlcal_clear' => ['8.3'],
        'intlrulebasedbreakiterator::settext' => ['8.3'],
        'intlcodepointbreakiterator::__construct' => ['8.3'],
        'intlcodepointbreakiterator::settext' => ['8.3'],
        'intldateformatter::settimezone' => ['8.3'],
        'intlchar::enumcharnames' => ['8.3'],
        'intlbreakiterator::settext' => ['8.3'],
        'intlcal_set_lenient' => ['8.3'],
        'intlcal_set_first_day_of_week' => ['8.3'],
        'datefmt_set_timezone' => ['8.3'],
        'imap_setflag_full' => ['8.3'],
        'imap_expunge' => ['8.3'],
        'imap_gc' => ['8.3'],
        'imap_undelete' => ['8.3'],
        'imap_delete' => ['8.3'],
        'imap_clearflag_full' => ['8.3'],
        'imap_close' => ['8.3'],
    ];
