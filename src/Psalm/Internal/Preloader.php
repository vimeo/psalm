...
final class Preloader {
    ...
    public static function preload(): void {
        ...
        class_exists(\AdvancedJsonRpc\Dispatcher::class);
        class_exists(\AdvancedJsonRpc\Error::class);
        class_exists(\AdvancedJsonRpc\ErrorCode::class);
        class_exists(\AdvancedJsonRpc\ErrorResponse::class);
        class_exists(\AdvancedJsonRpc\Notification::class);
        class_exists(\AdvancedJsonRpc\Request::class);
        class_exists(\AdvancedJsonRpc\Response::class);
        class_exists(\AdvancedJsonRpc\SuccessResponse::class);
        class_exists(\Amp\ByteStream\AsyncWriter::class);
        class_exists(\Amp\ByteStream\Base64\Base64DecodingReadableStream::class);
        class_exists(\Amp\ByteStream\Base64\Base64DecodingWritableStream::class);
        class_exists(\Amp\ByteStream\Base64\Base64EncodingReadableStream::class);
        class_exists(\Amp\ByteStream\Base64\Base64EncodingWritableStream::class);
        class_exists(\Amp\ByteStream\BufferException::class);
        class_exists(\Amp\ByteStream\BufferedReader::class);
        class_exists(\Amp\ByteStream\ClosedException::class);
        class_exists(\Amp\ByteStream\Compression\CompressingReadableStream::class);
        class_exists(\Amp\ByteStream\Compression\CompressingWritableStream::class);
        class_exists(\Amp\ByteStream\Compression\DecompressingReadableStream::class);
        class_exists(\Amp\ByteStream\Compression\DecompressingWritableStream::class);
        class_exists(\Amp\ByteStream\Internal\ChannelParser::class);
        class_exists(\Amp\ByteStream\Payload::class);
        class_exists(\Amp\ByteStream\PendingReadError::class);
        class_exists(\Amp\ByteStream\Pipe::class);
        class_exists(\Amp\ByteStream\ReadableBuffer::class);
        class_exists(\Amp\ByteStream\ReadableIterableStream::class);
        class_exists(\Amp\ByteStream\ReadableResourceStream::class);
        class_exists(\Amp\ByteStream\ReadableStream::class);
        class_exists(\Amp\ByteStream\ReadableStreamChain::class);
        class_exists(\Amp\ByteStream\ReadableStreamIteratorAggregate::class);
        class_exists(\Amp\ByteStream\ResourceStream::class);
        class_exists(\Amp\ByteStream\StreamChannel::class);
        class_exists(\Amp\ByteStream\StreamException::class);
        class_exists(\Amp\ByteStream\WritableBuffer::class);
        class_exists(\Amp\ByteStream\WritableIterableStream::class);
        class_exists(\Amp\ByteStream\WritableResourceStream::class);
        class_exists(\Amp\ByteStream\WritableStream::class);
        class_exists(\Amp\Cache\AtomicCache::class);
        class_exists(\Amp\Cache\Cache::class);
        class_exists(\Amp\Cache\CacheException::class);
        class_exists(\Amp\Cache\LocalCache::class);
        class_exists(\Amp\Cache\NullCache::class);
        class_exists(\Amp\Cache\PrefixCache::class);
        class_exists(\Amp\Cache\SerializedCache::class);
        class_exists(\Amp\Cache\StringCache::class);
        class_exists(\Amp\Cache\StringCacheAdapter::class);
        class_exists(\Amp\Cancellation::class);
        class_exists(\Amp\CancelledException::class);
        class_exists(\Amp\Closable::class);
        class_exists(\Amp\CompositeCancellation::class);
        class_exists(\Amp\CompositeException::class);
        class_exists(\Amp\CompositeLengthException::class);
        class_exists(\Amp\DeferredCancellation::class);
        class_exists(\Amp\DeferredFuture::class);
        class_exists(\Amp\Dns\BlockingFallbackDnsResolver::class);
        class_exists(\Amp\Dns\DnsConfig::class);
        class_exists(\Amp\Dns\DnsConfigException::class);
        class_exists(\Amp\Dns\DnsConfigLoader::class);
        class_exists(\Amp\Dns\DnsException::class);
        class_exists(\Amp\Dns\DnsRecord::class);
        class_exists(\Amp\Dns\DnsResolver::class);
        class_exists(\Amp\Dns\DnsTimeoutException::class);
        class_exists(\Amp\Dns\HostLoader::class);
        class_exists(\Amp\Dns\Internal\Socket::class);
        class_exists(\Amp\Dns\Internal\TcpSocket::class);
        class_exists(\Amp\Dns\Internal\UdpSocket::class);
        class_exists(\Amp\Dns\InvalidNameException::class);
        class_exists(\Amp\Dns\MissingDnsRecordException::class);
        class_exists(\Amp\Dns\Rfc1035StubDnsResolver::class);
        class_exists(\Amp\Dns\StaticDnsConfigLoader::class);
        class_exists(\Amp\Dns\UnixDnsConfigLoader::class);
        class_exists(\Amp\Dns\WindowsDnsConfigLoader::class);
        class_exists(\Amp\ForbidCloning::class);
        class_exists(\Amp\ForbidSerialization::class);
        class_exists(\Amp\Future::class);
        class_exists(\Amp\Future\UnhandledFutureError::class);
        class_exists(\Amp\Internal\Cancellable::class);
        class_exists(\Amp\Internal\FutureIterator::class);
        class_exists(\Amp\Internal\FutureIteratorQueue::class);
        class_exists(\Amp\Internal\FutureState::class);
        class_exists(\Amp\Internal\WrappedCancellation::class);
        class_exists(\Amp\Interval::class);
        class_exists(\Amp\NullCancellation::class);
        class_exists(\Amp\PHPUnit\AsyncTestCase::class);
        class_exists(\Amp\PHPUnit\CallbackStub::class);
        class_exists(\Amp\PHPUnit\TestException::class);
        class_exists(\Amp\PHPUnit\UnhandledException::class);
        class_exists(\Amp\Parallel\Context\Context::class);
        class_exists(\Amp\Parallel\Context\ContextException::class);
        class_exists(\Amp\Parallel\Context\ContextFactory::class);
        class_exists(\Amp\Parallel\Context\ContextPanicError::class);
        class_exists(\Amp\Parallel\Context\DefaultContextFactory::class);
        class_exists(\Amp\Parallel\Context\Internal\AbstractContext::class);
        class_exists(\Amp\Parallel\Context\Internal\ContextChannel::class);
        class_exists(\Amp\Parallel\Context\Internal\ContextException::class);
        class_exists(\Amp\Parallel\Context\Internal\ContextMessage::class);
        class_exists(\Amp\Parallel\Context\Internal\ExitFailure::class);
        class_exists(\Amp\Parallel\Context\Internal\ExitResult::class);
        class_exists(\Amp\Parallel\Context\Internal\ExitSuccess::class);
        class_exists(\Amp\Parallel\Context\Internal\ParallelHub::class);
        class_exists(\Amp\Parallel\Context\ProcessContext::class);
        class_exists(\Amp\Parallel\Context\ProcessContextFactory::class);
        class_exists(\Amp\Parallel\Context\StatusError::class);
        class_exists(\Amp\Parallel\Context\ThreadContext::class);
        class_exists(\Amp\Parallel\Context\ThreadContextFactory::class);
        class_exists(\Amp\Parallel\Ipc\IpcHub::class);
        class_exists(\Amp\Parallel\Ipc\LocalIpcHub::class);
        class_exists(\Amp\Parallel\Ipc\SocketIpcHub::class);
        class_exists(\Amp\Parallel\Worker\ContextWorkerFactory::class);
        class_exists(\Amp\Parallel\Worker\ContextWorkerPool::class);
        class_exists(\Amp\Parallel\Worker\DelegatingWorkerPool::class);
        class_exists(\Amp\Parallel\Worker\Execution::class);
        class_exists(\Amp\Parallel\Worker\Internal\ContextWorker::class);
        class_exists(\Amp\Parallel\Worker\Internal\JobCancellation::class);
        class_exists(\Amp\Parallel\Worker\Internal\JobChannel::class);
        class_exists(\Amp\Parallel\Worker\Internal\JobMessage::class);
        class_exists(\Amp\Parallel\Worker\Internal\JobPacket::class);
        class_exists(\Amp\Parallel\Worker\Internal\PooledWorker::class);
        class_exists(\Amp\Parallel\Worker\Internal\TaskCancelled::class);
        class_exists(\Amp\Parallel\Worker\Internal\TaskExceptionType::class);
        class_exists(\Amp\Parallel\Worker\Internal\TaskFailure::class);
        class_exists(\Amp\Parallel\Worker\Internal\TaskResult::class);
        class_exists(\Amp\Parallel\Worker\Internal\TaskSubmission::class);
        class_exists(\Amp\Parallel\Worker\Internal\TaskSuccess::class);
        class_exists(\Amp\Parallel\Worker\LimitedWorkerPool::class);
        class_exists(\Amp\Parallel\Worker\Task::class);
        class_exists(\Amp\Parallel\Worker\TaskCancelledException::class);
        class_exists(\Amp\Parallel\Worker\TaskFailureError::class);
        class_exists(\Amp\Parallel\Worker\TaskFailureException::class);
        class_exists(\Amp\Parallel\Worker\TaskFailureThrowable::class);
        class_exists(\Amp\Parallel\Worker\Worker::class);
        class_exists(\Amp\Parallel\Worker\WorkerException::class);
        class_exists(\Amp\Parallel\Worker\WorkerFactory::class);
        class_exists(\Amp\Parallel\Worker\WorkerPool::class);
        class_exists(\Amp\Parser\InvalidDelimiterError::class);
        class_exists(\Amp\Parser\Parser::class);
        class_exists(\Amp\Pipeline\ConcurrentIterator::class);
        class_exists(\Amp\Pipeline\DisposedException::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentArrayIterator::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentChainedIterator::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentClosureIterator::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentFlatMapIterator::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentIterableIterator::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentMergedIterator::class);
        class_exists(\Amp\Pipeline\Internal\ConcurrentQueueIterator::class);
        class_exists(\Amp\Pipeline\Internal\FlatMapOperation::class);
        class_exists(\Amp\Pipeline\Internal\IntermediateOperation::class);
        class_exists(\Amp\Pipeline\Internal\QueueState::class);
        class_exists(\Amp\Pipeline\Internal\Sequence::class);
        class_exists(\Amp\Pipeline\Internal\SortOperation::class);
        class_exists(\Amp\Pipeline\Pipeline::class);
        class_exists(\Amp\Pipeline\Queue::class);
        class_exists(\Amp\Process\Internal\Posix\PosixHandle::class);
        class_exists(\Amp\Process\Internal\Posix\PosixRunner::class);
        class_exists(\Amp\Process\Internal\ProcHolder::class);
        class_exists(\Amp\Process\Internal\ProcessContext::class);
        class_exists(\Amp\Process\Internal\ProcessHandle::class);
        class_exists(\Amp\Process\Internal\ProcessRunner::class);
        class_exists(\Amp\Process\Internal\ProcessStatus::class);
        class_exists(\Amp\Process\Internal\ProcessStreams::class);
        class_exists(\Amp\Process\Internal\Windows\HandshakeException::class);
        class_exists(\Amp\Process\Internal\Windows\HandshakeStatus::class);
        class_exists(\Amp\Process\Internal\Windows\SignalCode::class);
        class_exists(\Amp\Process\Internal\Windows\SocketConnector::class);
        class_exists(\Amp\Process\Internal\Windows\WindowsHandle::class);
        class_exists(\Amp\Process\Internal\Windows\WindowsRunner::class);
        class_exists(\Amp\Process\Process::class);
        class_exists(\Amp\Process\ProcessException::class);
        class_exists(\Amp\Serialization\CompressingSerializer::class);
        class_exists(\Amp\Serialization\JsonSerializer::class);
        class_exists(\Amp\Serialization\NativeSerializer::class);
        class_exists(\Amp\Serialization\PassthroughSerializer::class);
        class_exists(\Amp\Serialization\SerializationException::class);
        class_exists(\Amp\Serialization\Serializer::class);
        class_exists(\Amp\SignalCancellation::class);
        class_exists(\Amp\SignalException::class);
        class_exists(\Amp\Socket\BindContext::class);
        class_exists(\Amp\Socket\Certificate::class);
        class_exists(\Amp\Socket\CidrMatcher::class);
        class_exists(\Amp\Socket\ClientTlsContext::class);
        class_exists(\Amp\Socket\ConnectContext::class);
        class_exists(\Amp\Socket\ConnectException::class);
        class_exists(\Amp\Socket\DnsSocketConnector::class);
        class_exists(\Amp\Socket\InternetAddress::class);
        class_exists(\Amp\Socket\InternetAddressVersion::class);
        class_exists(\Amp\Socket\PendingAcceptError::class);
        class_exists(\Amp\Socket\PendingReceiveError::class);
        class_exists(\Amp\Socket\ResourceServerSocket::class);
        class_exists(\Amp\Socket\ResourceServerSocketFactory::class);
        class_exists(\Amp\Socket\ResourceSocket::class);
        class_exists(\Amp\Socket\ResourceUdpSocket::class);
        class_exists(\Amp\Socket\RetrySocketConnector::class);
        class_exists(\Amp\Socket\ServerSocket::class);
        class_exists(\Amp\Socket\ServerSocketFactory::class);
        class_exists(\Amp\Socket\ServerTlsContext::class);
        class_exists(\Amp\Socket\Socket::class);
        class_exists(\Amp\Socket\SocketAddress::class);
        class_exists(\Amp\Socket\SocketAddressType::class);
        class_exists(\Amp\Socket\SocketConnector::class);
        class_exists(\Amp\Socket\SocketException::class);
        class_exists(\Amp\Socket\SocketPool::class);
        class_exists(\Amp\Socket\Socks5SocketConnector::class);
        class_exists(\Amp\Socket\StaticSocketConnector::class);
        class_exists(\Amp\Socket\TlsException::class);
        class_exists(\Amp\Socket\TlsInfo::class);
        class_exists(\Amp\Socket\TlsState::class);
        class_exists(\Amp\Socket\UdpSocket::class);
        class_exists(\Amp\Socket\UnixAddress::class);
        class_exists(\Amp\Socket\UnlimitedSocketPool::class);
        class_exists(\Amp\Sync\Barrier::class);
        class_exists(\Amp\Sync\Channel::class);
        class_exists(\Amp\Sync\ChannelException::class);
        class_exists(\Amp\Sync\Internal\ConcurrentIteratorChannel::class);
        class_exists(\Amp\Sync\KeyedMutex::class);
        class_exists(\Amp\Sync\KeyedSemaphore::class);
        class_exists(\Amp\Sync\LocalKeyedMutex::class);
        class_exists(\Amp\Sync\LocalKeyedSemaphore::class);
        class_exists(\Amp\Sync\LocalMutex::class);
        class_exists(\Amp\Sync\LocalParcel::class);
        class_exists(\Amp\Sync\LocalSemaphore::class);
        class_exists(\Amp\Sync\Lock::class);
        class_exists(\Amp\Sync\Mutex::class);
        class_exists(\Amp\Sync\Parcel::class);
        class_exists(\Amp\Sync\ParcelException::class);
        class_exists(\Amp\Sync\PosixSemaphore::class);
        class_exists(\Amp\Sync\PrefixedKeyedMutex::class);
        class_exists(\Amp\Sync\PrefixedKeyedSemaphore::class);
        class_exists(\Amp\Sync\PriorityQueue::class);
        class_exists(\Amp\Sync\RateLimitingSemaphore::class);
        class_exists(\Amp\Sync\Semaphore::class);
        class_exists(\Amp\Sync\SemaphoreMutex::class);
        class_exists(\Amp\Sync\SharedMemoryParcel::class);
        class_exists(\Amp\Sync\StaticKeyMutex::class);
        class_exists(\Amp\Sync\StaticKeySemaphore::class);
        class_exists(\Amp\Sync\SyncException::class);
        class_exists(\Amp\TimeoutCancellation::class);
        class_exists(\Amp\TimeoutException::class);
        class_exists(\Composer\Autoload\ClassLoader::class);
        class_exists(\Composer\InstalledVersions::class);
        class_exists(\Composer\Semver\Constraint\Constraint::class);
        class_exists(\Composer\Semver\VersionParser::class);
        class_exists(\Composer\XdebugHandler\XdebugHandler::class);
        class_exists(\Fidry\CpuCoreCounter\CpuCoreCounter::class);
        class_exists(\JsonMapper::class);
        class_exists(\Kelunik\Certificate\Certificate::class);
        class_exists(\LanguageServerProtocol\ClientCapabilities::class);
        class_exists(\LanguageServerProtocol\ClientInfo::class);
        class_exists(\LanguageServerProtocol\CodeAction::class);
        class_exists(\LanguageServerProtocol\CodeActionContext::class);
        class_exists(\LanguageServerProtocol\CodeActionKind::class);
        class_exists(\LanguageServerProtocol\CodeDescription::class);
        class_exists(\LanguageServerProtocol\Command::class);
        class_exists(\LanguageServerProtocol\CompletionItem::class);
        class_exists(\LanguageServerProtocol\CompletionItemKind::class);
        class_exists(\LanguageServerProtocol\CompletionList::class);
        class_exists(\LanguageServerProtocol\CompletionOptions::class);
        class_exists(\LanguageServerProtocol\Diagnostic::class);
        class_exists(\LanguageServerProtocol\DiagnosticSeverity::class);
        class_exists(\LanguageServerProtocol\FileChangeType::class);
        class_exists(\LanguageServerProtocol\FileEvent::class);
        class_exists(\LanguageServerProtocol\Hover::class);
        class_exists(\LanguageServerProtocol\InitializeResult::class);
        class_exists(\LanguageServerProtocol\InitializeResultServerInfo::class);
        class_exists(\LanguageServerProtocol\InsertTextFormat::class);
        class_exists(\LanguageServerProtocol\Location::class);
        class_exists(\LanguageServerProtocol\LogMessage::class);
        class_exists(\LanguageServerProtocol\LogTrace::class);
        class_exists(\LanguageServerProtocol\MarkupContent::class);
        class_exists(\LanguageServerProtocol\MarkupKind::class);
        class_exists(\LanguageServerProtocol\MessageType::class);
        class_exists(\LanguageServerProtocol\ParameterInformation::class);
        class_exists(\LanguageServerProtocol\Position::class);
        class_exists(\LanguageServerProtocol\Range::class);
        class_exists(\LanguageServerProtocol\SaveOptions::class);
        class_exists(\LanguageServerProtocol\ServerCapabilities::class);
        class_exists(\LanguageServerProtocol\SignatureHelp::class);
        class_exists(\LanguageServerProtocol\SignatureHelpOptions::class);
        class_exists(\LanguageServerProtocol\SignatureInformation::class);
        class_exists(\LanguageServerProtocol\TextDocumentContentChangeEvent::class);
        class_exists(\LanguageServerProtocol\TextDocumentIdentifier::class);
        class_exists(\LanguageServerProtocol\TextDocumentItem::class);
        class_exists(\LanguageServerProtocol\TextDocumentSyncKind::class);
        class_exists(\LanguageServerProtocol\TextDocumentSyncOptions::class);
        class_exists(\LanguageServerProtocol\TextEdit::class);
        class_exists(\LanguageServerProtocol\VersionedTextDocumentIdentifier::class);
        class_exists(\LanguageServerProtocol\WorkspaceEdit::class);
        class_exists(\League\Uri\Uri::class);
        class_exists(\League\Uri\UriString::class);
        class_exists(\LibDNS\Decoder\Decoder::class);
        class_exists(\LibDNS\Decoder\DecoderFactory::class);
        class_exists(\LibDNS\Encoder\Encoder::class);
        class_exists(\LibDNS\Encoder\EncoderFactory::class);
        class_exists(\LibDNS\Messages\Message::class);
        class_exists(\LibDNS\Messages\MessageFactory::class);
        class_exists(\LibDNS\Messages\MessageResponseCodes::class);
        class_exists(\LibDNS\Messages\MessageTypes::class);
        class_exists(\LibDNS\Records\Question::class);
        class_exists(\LibDNS\Records\QuestionFactory::class);
        class_exists(\LibDNS\Records\ResourceQTypes::class);
        class_exists(\LibDNS\Records\ResourceTypes::class);
        ...
        class_exists(\Revolt\EventLoop\Driver\TracingDriver::class);
        class_exists(\Revolt\EventLoop\FiberLocal::class);
        class_exists(\SebastianBergmann\Diff\Differ::class);
        class_exists(\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder::class);
        class_exists(\Spatie\ArrayToXml\ArrayToXml::class);
        class_exists(\Symfony\Component\Console\Application::class);
        class_exists(\Symfony\Component\Console\Command\Command::class);
        class_exists(\Symfony\Component\Console\Helper\Table::class);
        class_exists(\Symfony\Component\Console\Input\InputArgument::class);
        class_exists(\Symfony\Component\Console\Input\InputOption::class);
        class_exists(\Symfony\Component\Console\Output\BufferedOutput::class);
        class_exists(\Symfony\Component\Console\Style\SymfonyStyle::class);
        class_exists(\Symfony\Component\Filesystem\Path::class);
        class_exists(\XdgBaseDir\Xdg::class);
