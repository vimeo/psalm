...
use Psalm\Internal\LanguageServer\Client\TextDocument;
use Psalm\Internal\LanguageServer\Client\Workspace;
...
use Psalm\Node\Expr\Cast\VirtualUnset;
...
use Psalm\Node\Scalar\MagicConst\VirtualClass;
use Psalm\Node\Scalar\MagicConst\VirtualDir;
use Psalm\Node\Scalar\MagicConst\VirtualFile;
use Psalm\Node\Scalar\MagicConst\VirtualFunction;
use Psalm\Node\Scalar\MagicConst\VirtualLine;
use Psalm\Node\Scalar\MagicConst\VirtualMethod;
use Psalm\Node\Scalar\MagicConst\VirtualNamespace;
use Psalm\Node\Scalar\MagicConst\VirtualTrait;
