        ...
        foreach ($stmts as $stmt) {
            ...
            if ($stmt instanceof PhpParser\Node\Stmt\Expression) {
                ...
                $if_block_return_types = self::getReturnTypes(
                    ...
                    $stmt->stmts,
                    $yield_types,
                    block_has_void: $if_block_has_void,
                );
                if ($if_block_has_void || $if_block_return_types === []) {
                    $any_if_block_has_void = true;
                }
                ...
                foreach ($stmt->elseifs as $elseif) {
                    $elseif_block_return_types = self::getReturnTypes(
                        ...
                        $elseif->stmts,
                        $yield_types,
                        block_has_void: $elseif_block_has_void,
                    );
                    if ($elseif_block_has_void || $elseif_block_return_types === []) {
                        $any_if_block_has_void = true;
                    }
                ...
                if ($stmt->else) {
                    $else_block_return_types = self::getReturnTypes(
                        ...
                        $stmt->else->stmts,
                        $yield_types,
                        block_has_void: $else_block_has_void,
                    );
                    if ($else_block_has_void || $else_block_return_types === []) {
                        $any_if_block_has_void = true;
                    }
