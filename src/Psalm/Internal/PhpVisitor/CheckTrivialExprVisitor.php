...
{
    /**
     * @var array<int, PhpParser\Node\Expr|PhpParser\Node\ClosureUse>
     */
    protected array $non_trivial_expr = [];

    private function checkNonTrivialExpr(PhpParser\Node\Expr|PhpParser\Node\ClosureUse $node): bool
    {
    ...
    {
        if ($node instanceof PhpParser\Node\Expr || $node instanceof PhpParser\Node\ClosureUse) {
